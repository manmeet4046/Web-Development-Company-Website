@include('layouts.partials.header')
    ...
    <div id="services" class="about page-section">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="projects-holder">
                        <div class="row">
                            <div class="col-md-3 col-sm-6 project-item mix workspace">
                              <div class="thumb">
                                  <div class="image">
                                    <img src="{{asset('assets/img/portfolio_01.jpg')}}">
                                  </div>
                                  <div class="hover-effect">
                                    <a href="{{asset('assets/img/portfolio_big_01.jpg')}}" data-lightbox="image-1"><i class="fa fa-search"></i></a>
                                  </div>
                              </div>
                            </div>
                            <div class="col-md-3 col-sm-6 project-item mix workspace">
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="blog-item b1">
                        <div class="thumb">
                            <img src="{{asset('assets/img/blog_01.jpg')}}" alt="">
                ...
                <div class="col-md-6">
                    <div class="blog-item second-blog b2">
                        <div class="thumb">
                            <img src="{{asset('assets/img/blog_02.jpg')}}" alt="">
                            <div class="text-content">
                ...
                <div class="col-md-6">
                    <div class="blog-item b3">
                        <div class="thumb">
                            <img src="{{asset('assets/img/blog_03.jpg')}}" alt="">
                            <div class="text-content">
